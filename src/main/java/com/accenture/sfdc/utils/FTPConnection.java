...
/**
 * Clase para gestionar la conexion con el FTP. Implementa el patrón Singleton
 * para garantizar sólo una instancia de conexión con el FTP en toda la
 * aplicación
 *
 */
public class FTPConnection {
	...
	/**
	 * Constructor privado. Únicamente puede ser llamado por esta misma clase, no
	 * pudiendo construirse un objeto FTPConnection desde ningun otro lugar de la
	 * aplicacion.
	 */
	...
	/**
	 * Método para obtener ficheros del servidor FTP. Obtiene los bytes del fichero
	 * indicado, permitiendo así obtener cualquier tipo de fichero.
	 * 
	 * @param filePath
	 * @return
	 * @throws IOException
