...
public class CSVAnalizer {
	 ...
	 * @return Devuelve una lista que contiene una fila del CSV en cada una de sus posiciones.
	 * @throws IOException 
	 */
	...
	/**
	 * Método que obtiene cada una de las filas del CSV asociando el nombre de cada columna con su valor
	 * @param line
	 * @param columnNames
	 * @return Devuelve el equivalente a una fila del CSV, teniendo como clave el nombre de cada columna.
	 */
